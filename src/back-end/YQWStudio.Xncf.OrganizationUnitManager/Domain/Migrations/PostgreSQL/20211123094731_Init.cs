...
namespace YQWStudio.Xncf.OrganizationUnitManager.Domain.Migrations.PostgreSQL
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "YQWStudio_OrganizationUnitManager_Color",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SenparcDemo_OrganizationUnitManager_Color", x => x.Id);
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(
                name: "SenparcDemo_OrganizationUnitManager_Color");
        }
    }
}
